      ...
      <>
        <div className={styles.container}>
            <div className={ styles.main }>
                <Card h="700px" w="1360px" backgroundImage={"./bg.jpg"} backgroundSize={"contain"} backgroundBlendMode={"darken"}  variant="outline" borderRadius={ "3xl" }> 
                        <Flex style={{display:"flex",flexDirection:"column", alignItems:"center", justifyContent:"center", marginTop:"80px"}} >
                            <Heading color={"pink.500"} >Better Investment Metrics</Heading>
                             <Heading size={"xl"}> Streamline Your Investments with a Diverse DEX Portfolio</Heading>
                             <Heading mt={4} size={"md"}> Simplify Your Investment Strategy with Decentralized Dollar-Cost Averaging </Heading>
                        </Flex>
                        <Flex style={ { display: "flex", flexDirection: "row", justifyContent: "center", marginTop: "20px" } } >
                        ...
                        <Flex className="drop-in-2" style={{display:"flex",flexDirection:"row", justifyContent:"center", animation:"ease-in"}} >
                ...
                <Box mt={'280px'} mb={"70px"} w="1360px" borderRadius={ "3xl" }> 
                        <Flex style={{display:"flex",flexDirection:"column", alignItems:"center", justifyContent:"center", marginTop:"100px"}} >
                            <Heading color={"pink.500"}>Hight Impact Results</Heading>
                             <Heading mt={3} size={"xl"}>Strategies Focused on Your Performance</Heading>
                             <Heading mt={4} size={"md"}>We help our clients achieve tangible, high-impact results.</Heading>
                        </Flex>
                        <SimpleGrid spacing={4} mt={"30px"}  templateColumns='repeat(auto-fill, minmax(260px, 1fr))'>
