         ...
         <div className={styles.container}>
            ...
            <Text mt={3} fontSize={"3xl"}>
              <b>
                ...
                <Tabs mt={'20px'}  variant='enclosed'>
                          <TabList>
                            <Tab _selected={{ color: 'white', bg: '#D53F8C' }}>View Summary</Tab>
                  <Tab _selected={ { color: 'white', bg: '#D53F8C' } }>View Permissions</Tab>
                <div style={ { display: "flex", flexDirection: "row", justifyContent: "flex-end", marginTop: "15px", width: "75%" } } >
                                              

                            <Button mr={2} variant={ "solid" } colorScheme="pink" >Withdrow</Button>
                  { ' ' }
                  <TransferPositionModal></TransferPositionModal>
                          </div>
                          </TabList>
                      <TabPanels>
                    <TabPanel>
